package com.lxj.rabbit.task.parser;
...
import com.lxj.rabbit.task.autoconfigure.JobZookeeperProperties;
import com.lxj.rabbit.task.enums.ElasticJobTypeEnum;
...
public class ElasticJobConfigParser implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public ElasticJobConfigParser(JobZookeeperProperties jobZookeeperProperties, ZookeeperRegistryCenter registryCenter) {
